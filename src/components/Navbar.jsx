...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto text-center flex w-5/6 justify-between links">
        ...
        <div className="text-3xl sm:text-2xl font-extrabold">
          <a href="/">Vikas Dhaka</a>
        </div>
        <div className="hidden sm:flex space-x-4 items-center text-sm">
          <Link className=" hover:text-white " to="/projects">
            Projects
          </Link>
          <Link className=" hover:text-white " to="/skill">
            Skills
          </Link>
        ...
        >
          ...
          <ul className="font-medium text-2xl space-y-4">
            ...
            <li>
              <Link to="/skill" onClick={closeMobileMenu}>
                Skills
              </Link>
            </li>{" "}
            <li>
